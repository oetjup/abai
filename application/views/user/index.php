                ...
                <div class="col-auto mr-auto">
                    <div class="form-row align-items-center">
                        <div class="col-auto my-1">
                            <button type="button" id="btnAddUser" class="btn btn-outline-primary btn-sm"><i class="fa fa-plus-circle"></i> <span>Add</span></button>
                        </div>
                    </div>
                </div>
                <div class="col-auto">
...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span><strong>A B A I</strong> - AJUKAN PERBAIKAN MESIN ADM - 2022</span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<script>
    function edit(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('ticket/formedit'); ?>",
            data: {
                id: id
            },
            dataType: 'json',
    ...
    function detail(id) {
        $.ajax({
            type: "post",
            url: "<?php echo base_url('ticket/formdetail'); ?>",
            data: {
                id: id
            },
            dataType: 'json',
    ...
    function hapus(id) {
        Swal.fire({
            title: 'Hapus',
            text: "Yakin mengahapus data ticket " + id + "?",
            icon: 'warning',
