...
-- Dumping database structure for abai
CREATE DATABASE IF NOT EXISTS `abai` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `abai`;
...
INSERT INTO `ticket` (`id`, `no_ticket`, `content_ticket`, `file_ticket`, `created_by`, `created_date`, `process_date`, `finished_date`, `status`, `handle_by`, `reply_ticket`) VALUES
...
-- Dumping data for table abai.user: ~6 rows (approximately)
DELETE FROM `user`;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id`, `username`, `password`, `role`, `created_at`, `nama`, `id_kel`, `adm_loc`) VALUES
	...
	(5, 'agi', '$2y$10$mR.qWKQsMZw/bOwTJbCJjOTwZq3LRVxMkDrxHEA6n225ug6UqEiWi', '2', '2022-09-27 19:34:07', 'Agi Ayubi', NULL, ''),
	(6, 'andri', '$2y$10$veSEO5okxEcIDtwhosaNKu/RSuAOTqhmLmhSJUgLB2qz5mNE3FgFa', '2', '2022-09-27 19:44:51', 'Andri Kuswandani', NULL, NULL);
